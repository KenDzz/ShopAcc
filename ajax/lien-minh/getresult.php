...
$sql = "SELECT * from shop_nick_info WHERE idLG = 2 ORDER BY trang_thai";
$paginationlink = "ajax/lien-minh/getresult.php?page=";	
...
if (isset($faq)) {
	foreach($faq as $k=>$v) {
		...
		echo "
				<div class='col-sm-3 p-3 text-acc-game' id='layout-acc-game'>
