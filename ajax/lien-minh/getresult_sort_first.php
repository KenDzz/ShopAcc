...
$sql = "SELECT `id`, `idLG`, `rank`, `tuong`, `skin`, `trang_thai`, `bang_ngoc`, rate - (rate*(discount/100)) as price,rate,discount, `img_1`, `img_2`, `img_3`, `img_4`, `img_5` FROM `shop_nick_info` ORDER BY price";

$paginationlink = "ajax/lien-minh/getresult_sort_first.php?page=";	
